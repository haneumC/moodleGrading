document.addEventListener('DOMContentLoaded', function() {
  // Look for the grading action section
  const gradingActionLabel = document.querySelector('label[for="menuaction"]') || 
                            document.querySelector('.gradingaction') ||
                            document.querySelector('label:contains("Grading action")');
